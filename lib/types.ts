...
export interface MarketSeriesPoint { period: string; newHomeIndex: number | null; resaleIndex: number | null; volume: number | null; inventory: number | null; basisVersion: string; quality?: QualityStatus; sourceUrl?: string; collectedAt?: string }
